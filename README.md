...
Разработка системы мониторинга тональности комментариев обусловлена критическими бизнес-потребностями:

1. **Юридическая безопасность и compliance**
   * РКН активно мониторит качество модерации и налагает существенные штрафы за недоработки
   * Система обеспечивает проактивное выявление потенциально опасного контента до привлечения внимания регуляторов

2. **Экономическая эффективность**
   * Ручная модерация 500K комментариев ежедневно требует содержания большого штата модераторов
   * Автоматизация позволяет перераспределить человеческие ресурсы на сложные кейсы, снижая операционные затраты

3. **Стратегическое развитие платформы**
   * Качественная модерация напрямую влияет на пользовательский опыт и лояльность аудитории
   * Оперативное выявление негатива позволяет быстро реагировать на проблемы и улучшать качество контента

4. **Технологическое лидерство**
   * Внедрение AI-решений становится отраслевым стандартом для крупных платформ
   * Система создает конкурентное преимущество и основу для будущих AI-продуктов
...
* **Критерии успеха:**
  * Модель достигает F1-score >0.9 на тестовой выборке;
  * Система снижает среднее время реакции на негатив с 24 часов до 1 часа;
